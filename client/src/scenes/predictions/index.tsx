        ...
        return monthData.map(({month, revenue}, i:number)=>{
            return {
                ...
                "Actual Revenue": revenue,
                 "Regression Line": regressionLine.points[i][1], //getting index and revenue
        ...
        >
            <FlexBetween m="1rem 2.5rem" gap="1rem">
                <Box>
                    ...
                    <Typography variant="h6">Charted revenue and predicted based on simple linear regression model</Typography>
                </Box>
